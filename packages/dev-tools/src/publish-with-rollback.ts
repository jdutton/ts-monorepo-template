 ...
 *
 * Set UPDATE_NEXT=true in the environment (e.g. from your publish.yml via
 * determine-publish-tags.ts) to trigger this after a stable release.
 */
