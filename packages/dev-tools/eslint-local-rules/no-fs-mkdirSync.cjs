 ...
 *
 * Prevents usage of fs.mkdirSync() in favor of mkdirSyncReal() from @ts-monorepo-template/example-utils
 *
...
module.exports = factory({
  ...
  message: 'Use mkdirSyncReal() from @ts-monorepo-template/example-utils instead of fs.mkdirSync() for Windows path normalization',
